...
- **JSON／Array／大型文字 Modal**：DataGrid 的 JSON、PostgreSQL array、含換行或超過 120 字元的文字可展開完整內容並一鍵複製；JSON 與 array 使用縮排格式與輸入驗證，安全可編輯的儲存格沿用 parameterized SQL preview、staged changes、原值與 row version 保護，無安全 row identity 或 Read-only 連線仍可唯讀檢視
...
[Unreleased]: https://git.cluion.com/ningyungame/loupedb/compare/v0.20.0...HEAD
[0.20.0]: https://git.cluion.com/ningyungame/loupedb/releases/tag/v0.20.0
[0.19.0]: https://git.cluion.com/ningyungame/loupedb/releases/tag/v0.19.0
[0.18.0]: https://git.cluion.com/ningyungame/loupedb/releases/tag/v0.18.0
